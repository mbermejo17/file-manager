 ...
 */
    ...
    const refreshFilesTable = data => {
        ...
        $u(".check").on("click", e => {
            ...
            if (userData.RunMode === "DEBUG") {
                ...
                console.log(e.target.parentNode.children[2].href);
            }
        });
    ...
    const showUserProfile = (w, h, t) => {
        ...
        ModalContent +=
            userData.AccessString.sharefiles === true ? "Allow" : "Deny";
        ModalContent += `</td></tr>
                    <tr><td>Allow delete Folder:</td><td>`;
        ModalContent +=
            userData.AccessString.deletefolder === true ? "Allow" : "Deny";
        ModalContent += `</td></tr>
                    <tr><td>Allow delete File:</td><td>`;
        ModalContent +=
            userData.AccessString.deletefile === true ? "Allow" : "Deny";
        ModalContent += `</td></tr>
        ...
        modalDialog("User Profile", htmlContent, modalDialogOptions);
    };
    ...
    const showNewFolder = (w, h, t) => {
        ...
        modalDialog("New Folder", "Folder Name", modalDialogOptions);
    ...
    const refreshBarMenu = () => {
        ...
        if (
            userData.AccessString.deletefolder === true &&
            userData.AccessString.deletefile === true
        ) {
