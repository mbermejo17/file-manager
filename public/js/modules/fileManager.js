...
function shareFile() {
    ...
    document.getElementById("btn-ShareFileAccept").addEventListener("click", function (e) {
        ...
        if (document.getElementById("FileExpirateDate").value === "") {
            strTime = (0, _moment2.default)(Date.now()).format("YYYY/MM/DD h:mm");
        } else {
            strTime = (0, _moment2.default)(document.getElementById("FileExpirateDate").value).format("YYYY/MM/DD h:mm");
        }

        if (document.getElementById("destUserName").value !== "") {
            if (userData.RunMode === "DEBUG") console.log(document.getElementById("destUserName").value);
            if (userData.RunMode === "DEBUG") console.log(document.getElementById("FileExpirateDate").value);
            var data = {
            ...
            _axios2.default.post("/files/share", data, {
                ...
                if (d.data.status === "OK") {
                    searchUserModalContent.style.display = "none";
                    containerOverlay.style.display = "none";
                    sendEmail(d.data.data.DestUser, "mbermejo17@gmail.com", "URL para descarga de archivo", "Descarga de archivo https://194.224.194.134/files/share/" + d.data.data.UrlCode);
...
function upload(Token) {
        ...
        _axios2.default.post("/files/upload?destPath=" + realpath, formData, {
            ...
            onUploadProgress: function onUploadProgress(progressEvent) {
                ...
                if (evt.total > 700000000) {
                    showToast('Error', fileName + " excede del tamaño soportado (700MB)", "error");
                    aListHandler[nFile]();
    ...
    $("#upload-input").on("change", function (e) {
        ...
        var htmlText = files.length > 0 ? files.length + " archivos seleccionados." : files[0];
...
function download(fileList, text) {
    ...
    var _loop = function _loop(i) {
        ...
        reqList[i].onloadend = function () {
            ...
            if (userData.RunMode === "DEBUG") console.log("File " + handlerCount + " downloaded");
        };
...
},{"./general":2,"axios":3,"moment":29}],2:[function(require,module,exports){
"use strict";
